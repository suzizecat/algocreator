// This defines the interface to the QsciLexerAlgo class.
//
// Copyright (c) 2012 Amidemoi.com
//
...
#ifndef QsciLexerAlgo_H
#define QsciLexerAlgo_H
...
//! \brief The QsciLexerAlgo class encapsulates the Scintilla ALGO
//! lexer.
class QSCINTILLA_EXPORT QsciLexerAlgo : public QsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a QsciLexerAlgo with parent \a parent.  \a parent is typically
    //! the QsciScintilla instance.  \a caseInsensitiveKeywords is true if the
    //! lexer ignores the case of keywords.
    QsciLexerAlgo(QObject *parent = 0, bool caseInsensitiveKeywords = false);

    //! Destroys the QsciLexerAlgo instance.
    virtual ~QsciLexerAlgo();
...
private:
    ...
    QsciLexerAlgo(const QsciLexerAlgo &);
    QsciLexerAlgo &operator=(const QsciLexerAlgo &);
};
